...
class cQTSmodel(object):
	MOD_LIST=(fc0012.ko, fc0013.ko, fc2580.ko, dvb-usb-rtl28xxu.ko, rtl2832.ko, af9013.ko, \
		dvb-core.ko, dvb_usb_v2.ko, qt1010.ko, af9033.ko, dvb-pll.ko, fc0011.ko, rtl2830.ko, \
		dib0070.ko, dvb-usb-af9015.ko, s5h1411.ko, dib0090.ko, dvb-usb-af9035.ko, it913x-fe.ko, \
		tda18218.ko, dib3000mc.ko, dvb-usb-dib0700.ko, lgdt3305.ko, tda18271.ko, dib7000m.ko, \
		dvb-usb-dtt200u.ko, mc44s803.ko, tua9001.ko, dib7000p.ko, dvb-usb-it913x.ko, mt2060.ko, \
		tuner-xc2028.ko, dib8000.ko, mt2266.ko, xc4000.ko, dib9000.ko, mxl5005s.ko, xc5000.ko, \
	...
	def __init__(self, modelDir):
		...
		self._qts=cQTSmodel(mdir)   #create .mk
		...
		self._kver, self._arch = self._cfg.getVrArch()
	...
	def prepareKernel(self):
		...
		os.system('cd '+self._modelDir+'; make -f .mk >/dev/null 2>&1')
	...
	def buildMedia(self):
		cmd=self._preCmd+'make -C '+self._qtsKernelDir+' M='+self._modelDir
		os.system(cmd+' clean')
		os.system(cmd)
